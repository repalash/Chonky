    ...
    return (
        <SvgIcon sx={{ width: 'auto', height: 'auto' }} {...props}>
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="main-gradient" x1="2" y1="15" x2="28" y2="15" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#B1B5EF"/>
                    <stop offset="1" stopColor="#898CF5"/>
                    </linearGradient>
                </defs>
                <mask id="mask0_95_627" maskUnits="userSpaceOnUse" x="0" y="0" width="30" height="30">
